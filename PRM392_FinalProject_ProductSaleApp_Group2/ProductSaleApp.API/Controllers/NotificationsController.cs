...
public class NotificationsController : ControllerBase
{
    ...
    [HttpGet("filter")]
    public async Task<ActionResult<PagedResponse<NotificationResponse>>> GetFilter([FromQuery] NotificationGetRequest request)
    {
        var filter = _mapper.Map<NotificationBM>(request);
