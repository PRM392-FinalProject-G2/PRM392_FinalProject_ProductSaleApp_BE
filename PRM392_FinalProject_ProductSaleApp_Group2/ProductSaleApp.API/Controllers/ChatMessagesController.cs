...
public class ChatMessagesController : ControllerBase
{
    ...
    [HttpGet("filter")]
    public async Task<ActionResult<PagedResponse<ChatMessageResponse>>> GetFilter([FromQuery] ChatMessageGetRequest request)
    {
        var filter = _mapper.Map<ChatMessageBM>(request);
